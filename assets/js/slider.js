...
var Slider = (function () {
  ...
  Slider.prototype.onResize = function onResize() {
    ...
    this.zDistance = getComputedStyle(
      document.documentElement
    ).getPropertyValue("--z-distance");
  ...
  Slider.prototype.switchBackgroundImage = function switchBackgroundImage(
    nextId
  ) {
